...
class ReportGenerationRequest(_message.Message):
    __slots__ = ("project_metadata", "anomaly_sets", "confidence_threshold")
    ...
    def __init__(self, project_metadata: _Optional[_Union[_anomaly_pb2.ProjectMetadata, _Mapping]] = ..., anomaly_sets: _Optional[_Iterable[_Union[_anomaly_pb2.AnomalySet, _Mapping]]] = ..., confidence_threshold: _Optional[float] = ...) -> None: ...
